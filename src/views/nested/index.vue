  ...
  <div class="app-container">
    <el-form inline="true" :model="formInline" class="demo-form-inline">
      <el-form-item label="活动名称">
        <el-input v-model="formInline.user" placeholder="活动名称" style="width: 200px" />
      </el-form-item>
      <el-form-item label="时间">
        <el-date-picker v-model="formInline.date" placeholder="选择大赛时间" style="width: 200px" />
      </el-form-item>
...
"
      ...
      <el-table-column prop="time" label="作品提交时间" align="center" />
      <el-table-column prop="time2" label="评审时间" align="center" />
